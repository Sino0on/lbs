    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_user', models.CharField(blank=True, choices=[('ADMIN', 'Admin'), ('DRIVER', 'Driver'), ('COMPANY', 'Company')], max_length=255, null=True, verbose_name='Тип пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('status', models.CharField(choices=[('NICE', 'Nice'), ('BAD', 'Bad')], max_length=255, verbose_name='Статус')),
                ('price', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='app.price', verbose_name='Цена')),
